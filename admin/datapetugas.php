  ...
  <div class="container">
            ...
            <div class="col-md-12 mt-3">
                    ...
                    <div class="card-header">
                        ...
                        <a class="btn btn-dark mt-4" style="margin-left: 890px; margin-bottom:5px; margin-right: 60px; border-radius: 8px" href="tambahuser.php" role="button"><i class="fa fa-user-plus"></i> Tambah Data</a>
                        <div class="card-body">
...
<td>
<a class="btn btn-outline-success" href="edit_user_admin.php?id=<?php echo $data['id_petugas'] ?>" role="button"><i class="fa fa-pencil"></i></a>
<a onClick="return confirm('Yakin Ingin Menghapus?')" class="btn btn-outline-danger" href="hapus_user_admin.php?idd=<?php echo $data['id_petugas'] ?>" role="button"><i class="fa fa-trash"></i></a>
</td>
</tr>
<?php }}else{
