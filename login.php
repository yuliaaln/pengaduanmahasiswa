...
<h5 class="text-center font-weight-bold"> Masuk Sebagai Mahasiswa</h5>
        ...
        <center>
            <button type="submit" name="submit" class="btn btn-block btn-success me-md-1" style= "text-decoration: none; border-radius: 20px; width: 180px;">Login</button>
                <div class="form-footer mt-2">
                    <a href="loginadmin.php" style="text-decoration: none;">Masuk Sebagai Admin</a></p>
                </div>
        </center>
...
<div class="wrapper">
        <div class="header" style="background-color:#B0B3B9">
                </div>
            </div>
<br><br><br>
